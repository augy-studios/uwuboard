...
const THEMES = {
  ...
  rainbow:  { name: 'Green with friends', swatch: 'linear-gradient(135deg, #ffcccc 0%, #ccccff 33%, #ffffcc 66%, #ccffcc 100%)', vars: { '--brand': '#ccffcc', '--brand-dark': '#22a85a', '--brand-mid': '#90e6b0', '--brand-border': 'rgba(34,168,90,0.25)', '--bg': '#fafffe', '--bg-col': 'rgba(204,255,204,0.28)', '--border': 'rgba(34,168,90,0.18)', '--border-strong': 'rgba(34,168,90,0.32)', '--text': '#1a2e22', '--text-2': '#3d6b50', '--text-3': '#6a9e7e', '--brand-rgb': '34,168,90', '--brand-tint-rgb': '204,255,204' } },
};
